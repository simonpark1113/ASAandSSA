...
class nnUNetTrainer(object):
    ...
    def build_network_architecture(architecture_class_name: str,
        ...
        print("build_network_architecture found")
        print("architecture_class_name: ", architecture_class_name)
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        if self.local_rank == 0:
            ...
            self.print_to_log_file("Mean Validation Precision: ", (metrics['foreground_mean']["precision"]), also_print_to_console=True)
            self.print_to_log_file("Mean Validation Recall: ", (metrics['foreground_mean']["recall"]), also_print_to_console=True)
            self.print_to_log_file("Mean Validation Dice Under: ", (metrics['foreground_mean_under']["Dice"]), also_print_to_console=True)
            self.print_to_log_file("Mean Validation Precision Under: ", (metrics['foreground_mean_under']["precision"]), also_print_to_console=True)
            self.print_to_log_file("Mean Validation Recall Under: ", (metrics['foreground_mean_under']["recall"]), also_print_to_console=True)
            self.print_to_log_file("Mean Validation Dice Over: ", (metrics['foreground_mean_over']["Dice"]), also_print_to_console=True)
            self.print_to_log_file("Mean Validation Precision Over: ", (metrics['foreground_mean_over']["precision"]), also_print_to_console=True)
            self.print_to_log_file("Mean Validation Recall Over: ", (metrics['foreground_mean_over']["recall"]), also_print_to_console=True)
