...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        print("####################################")
        print("Is cascaded?", self.is_cascaded)
        print("####################################")
    ...
    def get_dataloaders(self):
        ...
        tr_transforms_spatial = self.get_training_spatial_transforms(patch_size, rotation_for_DA, deep_supervision_scales, mirror_axes, do_dummy_2d_data_aug,
            use_mask_for_norm=self.configuration_manager.use_mask_for_norm,
            is_cascaded=self.is_cascaded, foreground_labels=self.label_manager.foreground_labels,
            regions=self.label_manager.foreground_regions if self.label_manager.has_regions else None,
            ignore_label=self.label_manager.ignore_label)
        
        tr_transforms_middle = self.get_training_middle_transforms(patch_size, rotation_for_DA, deep_supervision_scales, mirror_axes, do_dummy_2d_data_aug,
            use_mask_for_norm=self.configuration_manager.use_mask_for_norm,
            is_cascaded=self.is_cascaded, foreground_labels=self.label_manager.foreground_labels,
            regions=self.label_manager.foreground_regions if self.label_manager.has_regions else None,
            ignore_label=self.label_manager.ignore_label)
        
        tr_transforms_final = self.get_training_final_transforms(patch_size, rotation_for_DA, deep_supervision_scales, mirror_axes, do_dummy_2d_data_aug,
            use_mask_for_norm=self.configuration_manager.use_mask_for_norm,
            is_cascaded=self.is_cascaded, foreground_labels=self.label_manager.foreground_labels,
            regions=self.label_manager.foreground_regions if self.label_manager.has_regions else None,
            ignore_label=self.label_manager.ignore_label)
        
        tr_transforms = {'spatial': tr_transforms_spatial, 'middle': tr_transforms_middle, 'final': tr_transforms_final}        
    ...
    @staticmethod
    def get_training_spatial_transforms(
        ...
        transforms = []
        print("Building spatial transforms!!!!!!!!")
        if do_dummy_2d_data_aug:
            ignore_axes = (0,)
    ...
    @staticmethod
    def get_training_middle_transforms(
        patch_size: Union[np.ndarray, Tuple[int]],
        rotation_for_DA: RandomScalar,
        deep_supervision_scales: Union[List, Tuple, None],
        mirror_axes: Tuple[int, ...],
        ...
        print("Building middle transforms!!!!!!!!")
        if do_dummy_2d_data_aug:
            ignore_axes = (0,)
            transforms.append(Convert3DTo2DTransform())
            patch_size_spatial = patch_size[1:]
    ...
    @staticmethod
    def get_training_final_transforms(
        patch_size: Union[np.ndarray, Tuple[int]],
        rotation_for_DA: RandomScalar,
        deep_supervision_scales: Union[List, Tuple, None],
        mirror_axes: Tuple[int, ...],
        ...
        print("Building final transforms!!!!!!!!")
        transforms = []
        if mirror_axes is not None and len(mirror_axes) > 0:
            print("Mirror axes activated!!!!!!!!!!!!!!!")
            transforms.append(
                MirrorTransform(
        ...
        if use_mask_for_norm is not None and any(use_mask_for_norm):
            print("Mask image transform activated!!!!!!!!!!!!!!!")
        ...
        if is_cascaded:
            print("Cascaded augmentations activated!!!!!!!!!!!!!!!")
        ...
        if regions is not None:
            print("Convert segmentation to regions transform activated!!!!!!!!!!!!!!!")
        ...
        if deep_supervision_scales is not None:
            print("Downsample segmentation for deep supervision transform activated!!!!!!!!!!!!!!!")
