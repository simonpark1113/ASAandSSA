...
from nnunetv2.custom_model.unetBothAttMultiScale.unetDecoder import UNetDecoder
...
from nnunetv2.custom_model.unetBothAttMultiScale.unetEncoder import PlainConvEncoder

class customUnetBothAttMS(nn.Module):
    def __init__(self,
                 input_channels: int,
                 n_stages: int,
        ...
        """
        print("customUnetBoth - Attention - Multiscale")
        super().__init__()
    ...
    def forward(self, x):
        ...
        return self.decoder(skips_0, skips_flip, skips_label, skips_label_flip)
